...
data = pd.read_csv("./data/covid_19_uscan.csv")
labels = data.loc[:, "StateProvince"]
data = data.drop(["StateProvince"], axis=1)
pops = pd.read_csv("./data/state_pop.csv")
pops = pops.drop(["StateProvince"], axis=1)
print(data.shape)
print(pops.shape)
